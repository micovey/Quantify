...
year=int(now_time.year)-2##需要两年，6月前后算两次。
start_date1=str(int(year)+1)+'-06-29'##六月末按照市值分组，需要根据计算年份更改日期
start_date2=str(int(year)+1)+'-05-31'##五月末按照账面市值比分组，需要根据计算年份更改日期
...
for id in idcode:
    ...
    result2=get_history_data(id,start_date2,end_date2)##5月末账面价值比
